...
const Score = () => {
    return (
        <div className="score text-light-lavender text-center px-14 rounded-b-[1.7rem] md:rounded-[1.7rem] flex flex-col gap-y-5 pt-5 pb-8">
            ...
            <p className="font-bold text-white text-2xl">Great</p>
